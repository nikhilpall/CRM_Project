		...
		<div class="container-fluid admin-profile-div my-5">
			<div class="container">
				<div class="row py-5">
					...
					<div
						class="col-md-7 d-flex flex-column justify-content-center admin-details-div">
						<table>
							<tbody>
								<tr>
									<td>Role</td>
									<td>${adminObj.getRole()}</td>
								</tr>
								<tr>
									<td>Name</td>
									<td>${adminObj.getName()}</td>
								</tr>
								<tr>
									<td>Email</td>
									<td>${adminObj.getEmail()}</td>
								</tr>
								<tr>
									<td>Phone no</td>
									<td>${adminObj.getPhoneNo()}</td>
								</tr>
								<tr>
									<td>Address</td>
									<td>${adminObj.getAddress()}</td>
								</tr>
							</tbody>
						</table>
						<div class="admin-edit-details-div">
							<a href="editAdminPage"> <svg
