...
<body>
	<c:set var="profileUrl" value="${not empty m_profile_url ? m_profile_url : (not empty s_admin_obj ? s_admin_obj.getImagePath() : 'images/default-profile-pic.png')}"/>
						...
						<div class="dropdown">
							<button class="btn dropdown-toggle" type="button"
								...
								<img class="rounded-circle" src="${profileUrl}"
									alt="Profile Picture" width="40" /> Admin
							</button>
